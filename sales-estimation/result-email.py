    ...
    try:
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <ul style="margin: 6px 0 0 20px; padding: 0;">
                <li><strong>Actual Sales:</strong> Finalized sales from month start up to the report date.</li>
                <li><strong>Estimated Sales:</strong> Forecasted sales from the report date to month-end, based on weekday trends.</li>
                <li><strong>Total Estimation:</strong> Combined total of actual and estimated sales for the full month.</li>
            </ul>
        </div>
