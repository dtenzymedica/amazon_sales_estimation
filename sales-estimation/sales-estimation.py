...
class SalesEstimation:
    def __init__(self):
        self.master_file = r'C:\Users\d.tanubudhi\Documents\EnzymedicaCustomTransaction.csv'
        ...
        self.output_path = r'c:\Users\d.tanubudhi\Documents\US-EnzymedicaSalesReport.csv'
...
if __name__ == "__main__":
    ...
    result = estimator.sales_estimation(selected_date=datetime.today().day)
